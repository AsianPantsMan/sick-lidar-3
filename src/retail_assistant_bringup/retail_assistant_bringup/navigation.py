...
class AutoNav(Node):
    def __init__(self):
        ...
        self.has_previous_waypoints=False
    ...
    def send_nav_goal(self,x,y):
        ...
        if(self.has_previous_waypoints):
    ...
    def aisle_skip_callback(self,msg):
        if self.previous_waypoint is not None:
            ...
            max_distance=mt.sqrt((self.current_goal[0]-self.previous_waypoint[0])**2+(self.current_goal[1]-self.current_goal[1])**2)
