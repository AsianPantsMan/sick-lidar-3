...
void HAL_I2C_MspInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Pin = BACKUP_I2C_SDA_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF4_I2C1;
    HAL_GPIO_Init(BACKUP_I2C_SDA_GPIO_Port, &GPIO_InitStruct);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(BACKUP_I2C_SCL_GPIO_Port, BACKUP_I2C_SCL_Pin);

    HAL_GPIO_DeInit(BACKUP_I2C_SDA_GPIO_Port, BACKUP_I2C_SDA_Pin);
