  ...
  return (
    <div className="w-full relative">
      <input
        ...
        className="w-full max-w-none h-[3.25rem] px-4 rounded-xl border border-gray-300 bg-white shadow-lg focus:outline-none focus:ring-2 focus:ring-[#500000] text-lg text-black placeholder-gray-500"
